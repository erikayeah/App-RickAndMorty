...
const Card = ({name, id, image, onClose}) => { //destructuring de las pripierdades del objeto props. si no seria props sin {}, y abajo props.name y asi.
...
*/
   ...
   const handleFavorite = () => {
      if (isFav) {
         ...
         setIsFav(true);
         dispatch(addFav({name, id, image, onClose})); //Mismo caso si no hubiera hecho destructuring, seria props solo.
      }
   };
/*Version en ternario
   const handleFavorite = () => {
